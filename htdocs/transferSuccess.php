...
<div id="container">
    ...
    <div id="body">
	    ...
	    <article>
			...
			<ul>
				<li class=""><a href="userTransfers.php">Incoming Transfers</a></li>
				<li><a href="userTransfersOut.php">Outgoing Transfers</a></li>
				<li class="start selected"><a href="makeTransfers.php">Make New Transfer</a></li>
            ...
            <p>
				Transfer was successful! The amount will be available for use immediately.
