...
<div id="container">
    ...
    <div id="body">
		...
		$user_check=$_SESSION['username'];
			$delst=oci_parse($conn,'delete from complaints
						where complaint_id=:coid and acc_id=:acc');
			oci_bind_by_name($delst,":acc",$acc);
			oci_bind_by_name($delst,":coid",$coid);
			$r=oci_execute($delst);
			echo "<script type=\"text/javascript\"> alert(\"Complaint Deleted Successfully\"); window.location=\"adminComplaints.php\"; </script>";
		  ?>
		  </article>
