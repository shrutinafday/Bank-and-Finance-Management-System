...
<div id="container">
    ...
    <div id="body">
	    ...
	    <article>
			...
			<ul>
				<li class="start selected"><a href="#">Incoming Transfers</a></li>
			...
			$statement = oci_parse($conn,'select * from transfer_money t,account a where a.cust_id=:username and a.account_id=t.to_id');
			oci_bind_by_name($statement,":username",$user_check);
			$r=oci_execute($statement);
			echo "<table border='1'>\n";
			echo "<tr><th>From</th><th>Amount Transferred</th></tr>";
